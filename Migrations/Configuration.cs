...
ManufactureID= manufacturers.Single(x => x.ManufacturerName == "Apple").ManufactureID
},
new Phone {
PhoneName = "iPhone XR",
MSRP = 1000,
...
ManufactureID = manufacturers.Single(x =>  x.ManufacturerName == "Samsung").ManufactureID  }
};
